  ...
  return (
    <div className="flex min-h-screen bg-[#F0F9F9] font-sans antialiased relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden bg-pattern">
        <div className="absolute -top-[10%] -right-[5%] w-[60%] h-[60%] rounded-full bg-gradient-to-br from-[#14B8A6]/8 to-transparent blur-[100px]"></div>
        <div className="absolute bottom-[5%] -left-[10%] w-[50%] h-[50%] rounded-full bg-gradient-to-tr from-[#14B8A6]/6 to-transparent blur-[100px]"></div>
      </div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-white border-b border-[#E5F3F3] flex items-center justify-between px-4 z-40 shadow-sm">
        <div className="flex items-center gap-2">
          <svg viewBox="0 0 100 100" className="w-8 h-8 fill-current text-[#14B8A6]">
          ...
          <div>
            <h1 className="text-lg font-bold text-[#14B8A6] tracking-tight leading-tight">{AppConstants.APP_NAME}</h1>
          </div>
        </div>
        <button onClick={() => setIsSidebarOpen(!isSidebarOpen)} className="p-2 text-gray-500 hover:text-[#14B8A6] hover:bg-[#CCFBF1] rounded-lg transition-colors">
