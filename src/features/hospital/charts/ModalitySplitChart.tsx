...
export function ModalitySplitChart({ data }: { data: { name: string; value: number }[] }) {
  return (
    <div className="bg-white/40 backdrop-blur-xl rounded-2xl p-6 shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] border border-white/40 flex flex-col justify-between relative overflow-hidden">
